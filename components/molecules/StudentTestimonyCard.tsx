...
const StudentTestimonyCard = ({
  ...
  <Card
    className={"px-4 md:px-14 py-8  !bg-neutral06 rounded-3xl min-w-[350px] w-full lg:w-fit h-[300px]"}
  >
    <CardContent className={"space-y-2 !p-0 max-w-xs md:max-w-sm text-center mx-auto"}>
      <Image
        src={imageUrl}
        alt={name}
        width={100}
