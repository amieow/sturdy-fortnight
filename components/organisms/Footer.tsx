	...
	return (
		<footer className={"container bg-neutral08 py-12"}>
			<div className={"flex flex-col gap-6 md:flex-row justify-between"}>
				<div className={"space-y-[23px] md:max-w-[350px]"}>
					<IconLogoVertical
						width={106}
						height={72}
					/>
					...
					<div
						...
						<input
							className={
								" py-2 bg-transparent border-none outline-none flex-grow text-textM "
							}
				...
				<div className={"flex max-md:flex-wrap gap-8 h-fit"}>
			...
			<div
				className={"flex gap-6 max-md:flex-col-reverse justify-between mt-8"}>
	...
	<div className={"space-y-2"}>
		...
		<ul className={"space-y-4"}>
			{links.map(({ link, title }, index) => (
				<li
					key={index}
					className={"text-textM text-neutral02 text-left"}>
